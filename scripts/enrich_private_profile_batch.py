...
def enrich_batch(run_id: str, max_profiles: int, provider_name: str = "offline", *, private_root: Path = PRIVATE_ROOT) -> Path:
    ...
    provider = OfflineHeuristicEnrichmentProvider() if provider_name == "offline" else OpenAIEnrichmentProvider()
