...
def test_openapi_exposes_workflow_routes() -> None:
    ...
    required = {
        ...
        "/profile-drafts",
        "/profile-drafts/{profile_draft_id}",
        "/profile-drafts/generate",
        "/profile-drafts/{profile_draft_id}/approve",
        "/profile-drafts/{profile_draft_id}/reject",
        "/enrichment-reviews",
        ...
        "/enrichment-reviews",
        "/enrichment-reviews/{review_id}",
        "/enrichment-reviews/generate",
        "/enrichment-reviews/{review_id}/attach-source",
        "/enrichment-reviews/{review_id}/mark-ready",
        "/enrichment-reviews/{review_id}/approve",
        "/enrichment-reviews/{review_id}/reject",
        "/brands",
        "/fragrances",
