...
('enriched_original','Original enrichment prepared',false),('enrichment_started','Enrichment started',false),
('needs_source_review','Source permissions require review',false),('needs_human_review','Human review required',false),
('ready_for_approval','Ready for a human approval decision',false),('requires_more_sources','Additional permitted sources required',false),
('rejected_duplicate','Rejected as a duplicate',true),('approved_for_catalogue','Human-approved commercial catalogue record',true),
